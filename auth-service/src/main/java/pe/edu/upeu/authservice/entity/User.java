package pe.edu.upeu.authservice.entity;
...
public class User implements UserDetails {
    ...
    @Column(unique=true,nullable=false,length=8) private String dni;
    @Column(unique=true,nullable=false) private String email;
    @Column(unique=true,nullable=false,length=9) private String universityCode;
    @Column(unique=true,nullable=false,length=9) private String phone;
